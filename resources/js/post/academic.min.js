...
;(function ($) {
    ...
    function scrollToAnchor(target) {
        ...
        if ($(target).length) {
            ...
            $('html, body').animate({scrollTop: $(target).offset().top - navbar_offset}, 600, function () {
    ...
    $('#navbar-main li.nav-item a.nav-link').on('click', function (event) {
        ...
        if (this.pathname === window.location.pathname && hash && $(hash).length && ($(".js-widget-page").length > 0)) {
            ...
            $('html, body').animate({scrollTop: $(hash).offset().top - navbar_offset}, 800);
        }
    });
    ...
    function initMap() {
        if ($('#map').length) {
            ...
            if (map_provider == 1) {
                ...
                map.addMarker({
                    lat: lat, lng: lng, click: function (e) {
    ...
    $(window).on('load', function () {
        ...
        $('.js-read-modal').click(function (e) {
            ...
            window.location.replace("../../../viewer/web/viewer.html?file=https://post.tang5618.com"+filename);
        });
...
;let fuseOptions = {
    ...
    keys: [{name: 'title', weight: 0.99}, {name: 'summary', weight: 0.6}, {
        name: 'authors',
        weight: 0.5
    }, {name: 'content', weight: 0.2}, {name: 'tags', weight: 0.5}, {name: 'categories', weight: 0.5}]
};
